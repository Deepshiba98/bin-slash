...
client.on('message', (message) => {
    ...
    if(msg.startsWith(prefix + 'DENUNCIAR') || msg.startsWith(prefix + 'REPORT') || msg.startsWith(prefix + 'REPORTAR')){
        ...
        const reportado = new Discord.RichEmbed()
            ...
            .addField('🖼 | Prova:', motivo[1], true)
            .setThumbnail(client.user.avatarURL)
        client.channels.get('457905664417595405').send(reportado).then(msg => {
            msg.react('✅');
            msg.react('❌');
        });
    ...
    if(msg.startsWith(prefix + 'ENQUETE') || msg.startsWith(prefix + 'VOTAÇAO')){
        ...
        client.channels.get('459408848021749760').send('@everyone').then(msg => {
            msg.delete(5000);
        });

        message.reply(':white_check_mark: | Enquete criada com sucesso, confira em <#459408848021749760>.').then(msg => {
            msg.delete(10000);
        });
...
client.on('guildMemberAdd', member => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .setTimestamp()
    client.channels.get('457639367863697409').send({embed}).then(msg => {
        msg.react('🐷')
        msg.react('457583765129003009')
    });
